    ...
    return (
        <nav className="w-[20vw] min-h-screen bg-gray-100 dark:bg-gray-800 border-r-[1px] border-gray-200 dark:border-r-gray-800 p-4 flex flex-col">
            ...
            <ul className='pt-8 flex flex-col gap-1'>
                {menuItems.map((item) => (
                    <li data-active={pathname === item.href} key={item.href} className='data-[active=true]:bg-gray-200 dark:data-[active=true]:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 p-2 rounded-md transition-colors duration-200'>
